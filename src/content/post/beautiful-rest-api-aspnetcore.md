...
Today, I'll show you how to solve this problem with ASP.NET Core and the Ion hypermedia type. (If you want an introduction to ION, read [Modeling JSON APIs with Ion](/post/modeling-json-api-with-ion/)).
