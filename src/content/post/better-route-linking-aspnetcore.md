...
If you need to generate a URL in your application (to link to an MVC action, or for [HATEOAS](/post/what-is-hateoas/) in an API), ASP.NET Core provides the `Url` helper property in controllers and views:
